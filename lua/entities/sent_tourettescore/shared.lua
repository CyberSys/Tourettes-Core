...
ENT.Base			= "base_core3"
ENT.PrintName		= "Tourettes Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Instructions	= "Fuck you!" -- The instructions of the entity, Perhaps "Insert 1 chocolate cookie to activate."
...
ENT.Delay			= 1
ENT.Dir				= "tour" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
